...
@section('linkCss')
    <style>
        ...
        section a .box svg circle{
            stroke-dasharray: 0 !important; 
        }
        .subBox:first-child .s-time,
        .subBox:first-child .e-time{
            background-color: #45bbff2f !important;
        }
    </style>
@endsection
@section('TitleHead')
...
@section('container')
            <section>
                <div class="miniBox d-flex justify-content-around w-100 align-items-center">
                    <a href="#" class="bodySection boxLink">
                    ...
                    <a href="#" class="bodySection boxLink">
                        <div class="box TotalUser TotalDoctre d-flex flex-column">
                            ...
                            <span class="gree last">Last 24 Hours</span>
                        </div>
                    </a>
                    <a href="#" class="bodySection boxLink">
                        <div class="box TotalUser lastMessage d-flex flex-column">
                            ...
                            <span class="gree last">Last 2 Hours</span>
                        </div>
                    </a>
                </div>
